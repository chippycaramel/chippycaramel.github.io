...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFCD4B").s().p("AgGA5QgEgDAAgFQAAgEAEgDQADgDADAAQAEAAAEADQADADAAAEQAAAFgDADQgEADgEAAQgDAAgDgDgAgCAgQgBAAAAAAQgBAAAAAAQgBgBAAAAQAAgBAAgBIgBhVQAAAAAAgBQAAgBABAAQAAgBABAAQAAAAABAAIAHAAQABAAABAAQAAAAAAABQABAAAAABQAAABAAAAIAABVQAAABAAABQgBAAAAABQgBAAAAAAQgBAAgBAAg");
	this.shape.setTransform(245.625,7.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFCD4B").s().p("AAAAsQgPgBgOgIQgDgCACgDIADgGQABgDAEACIAPAGQAJACAHgCQAIgCAAgHQABgGgHgEQgEgDgLgEQgXgHgBgQQAAgLAJgGQAJgHAMABQANACAKAFQADACgCADIgDAGQgBACgEgBQgJgFgIAAQgNgBgCAJQgBAIATAHQANAFAFACQAJAHABAKQABAMgJAHQgJAHgOAAIgBAAg");
	this.shape_1.setTransform(239.9269,8.9699);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFCD4B").s().p("");
	this.shape_2.setTransform(231.5,8.975);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFCD4B").s().p("");
	this.shape_3.setTransform(223,8.975);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFCD4B").s().p("AgDA9QgBAAAAAAQgBgBAAAAQgBgBAAAAQAAgBAAgBIAAhNQAAgBAAgBQAAAAABgBQAAAAABgBQAAAAABAAIAHAAQABAAAAAAQABABAAAAQAAABABAAQAAABAAABIAABNQAAABAAABQgBAAAAABQAAAAgBABQAAAAgBAAgAgGgqQgDgEAAgEQAAgEADgDQADgDADAAQAEAAADADQADADAAAEQAAAEgDAEQgDADgEAAQgDAAgDgDg");
	this.shape_4.setTransform(217.375,7.175);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFCD4B").s().p("");
	this.shape_5.setTransform(212.55,8.95);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFCD4B").s().p("");
	this.shape_6.setTransform(204.15,11.0481);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFCD4B").s().p("");
	this.shape_7.setTransform(192.6771,8.1014);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFCD4B").s().p("");
	this.shape_8.setTransform(185.025,8.9059);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFCD4B").s().p("");
	this.shape_9.setTransform(176.35,8.975);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFCD4B").s().p("");
	this.shape_10.setTransform(169.05,8.95);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFCD4B").s().p("");
	this.shape_11.setTransform(160.5,11.075);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFCD4B").s().p("");
	this.shape_12.setTransform(146.325,6.8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFCD4B").s().p("");
	this.shape_13.setTransform(134.2521,7.2486);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFCD4B").s().p("AgdAfQgNgNgBgSQABgRANgNQAMgMARAAQASAAANAMQANANAAARQAAASgNANQgNAMgSAAQgRAAgMgMgAgTgUQgJAJAAALQAAAMAJAJQAIAJALAAQANAAAHgJQAJgJAAgMQAAgLgJgJQgHgJgNAAQgLAAgIAJg");
	this.shape_14.setTransform(125.85,8.975);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFCD4B").s().p("AgGBAIAAhjIgTAAIAAgcIAzAAIAAB/g");
	this.shape_15.setTransform(110.975,6.8);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFCD4B").s().p("");
	this.shape_16.setTransform(97.725,8.9444);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFCD4B").s().p("AgDA9QgBAAAAAAQgBgBAAAAQgBgBAAAAQAAgBAAgBIAAhNQAAgBAAgBQAAAAABgBQAAAAABgBQAAAAABAAIAHAAQABAAAAAAQABABAAAAQABABAAAAQAAABAAABIAABNQAAABAAABQAAAAgBABQAAAAgBABQAAAAgBAAgAgGgqQgDgEAAgEQAAgEADgDQADgDADAAQAEAAADADQADADAAAEQAAAEgDAEQgDADgEAAQgDAAgDgDg");
	this.shape_17.setTransform(91.225,7.175);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFCD4B").s().p("");
	this.shape_18.setTransform(83.3,8.975);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFCD4B").s().p("");
	this.shape_19.setTransform(68.85,7.3019);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFCD4B").s().p("AALA8QgMAAgIgIQgHgIAAgNIAAhWQAAgBAAgBQAAAAAAgBQABAAAAgBQABAAABAAIAHAAQABAAABAAQAAABABAAQAAABABAAQAAABAAABIAABWQAAAPAPAAIABAAQABAAAAAAQABABAAAAQABAAAAABQAAABAAAAIAAAHQAAABAAABQAAAAgBABQAAAAgBABQAAAAgBAAg");
	this.shape_20.setTransform(62.125,7.275);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFCD4B").s().p("");
	this.shape_21.setTransform(54.725,9.0056);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFCD4B").s().p("AgeAfQgNgNABgSQgBgRANgNQANgMARAAQASAAANAMQANANAAARQAAASgNANQgNAMgSAAQgRAAgNgMgAgUgUQgIAJAAALQAAAMAIAJQAIAJAMAAQAMAAAJgJQAIgJAAgMQAAgLgIgJQgJgJgMAAQgLAAgJAJg");
	this.shape_22.setTransform(45.1,8.975);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFCD4B").s().p("AgXAfQgNgNAAgSQAAgRANgNQANgMAQAAQARAAAMALQABAAAAABQABABAAAAQAAABgBAAQAAABgBAAIgFAFQAAAAgBABQAAAAgBAAQAAAAgBAAQAAgBgBAAQgKgHgKAAQgLAAgIAJQgJAJAAALQAAAMAJAJQAIAJALAAQAKAAAKgHQABAAAAgBQABAAAAAAQABAAAAAAQABABAAAAIAFAEQACADgCACQgMALgRAAQgQAAgNgMg");
	this.shape_23.setTransform(35.6125,8.975);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFCD4B").s().p("");
	this.shape_24.setTransform(23.025,9.0056);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFCD4B").s().p("AgeAfQgMgNAAgSQAAgRAMgNQANgMARAAQASAAANAMQAMANAAARQAAASgMANQgNAMgSAAQgRAAgNgMgAgUgUQgIAJAAALQAAAMAIAJQAJAJALAAQAMAAAJgJQAIgJAAgMQAAgLgIgJQgJgJgMAAQgLAAgJAJg");
	this.shape_25.setTransform(13.4,8.975);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFCD4B").s().p("AgDA8QgBAAAAAAQgBgBAAAAQgBgBAAAAQAAgBAAgBIAAg1Igig6QgDgEAEAAIAJAAQADAAACADIAZAsQAAABAAAAQAAABAAAAQAAAAABgBQAAAAAAgBIAZgsQACgDADAAIAJAAQAEAAgDAEIgiA6IAAA1QAAABAAABQAAAAgBABQAAAAgBABQAAAAgBAAg");
	this.shape_26.setTransform(4.225,7.275);
...
p.nominalBounds = new cjs.Rectangle(0,0,246.7,17.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(148.3,39.975);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AASBmIgxhPIAABPIg0AAIAAjLIBSAAQAPAAANAFQANAGAIAIQAJAJAEALQADAKAAAOQABAYgLAOQgLANgXAFIBABUgAgfgKIAKAAQAQAAAHgGQAIgHAAgMQAAgNgIgFQgHgHgQAAIgKAAg");
	this.shape_1.setTransform(131.55,39.975);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("Ag5BmIAAjLIBzAAIAAAtIg+AAIAAAiIA6AAIAAAsIg6AAIAAAjIA+AAIAAAtg");
	this.shape_2.setTransform(113.525,39.975);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAoBmIgoh1IgmB1Ig2AAIg9jLIA3AAIAjCDIAriDIApAAIArCDIAjiDIA3AAIg8DLg");
	this.shape_3.setTransform(90.15,39.975);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(66,39.975);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAxBmIhgh8IAAB8Ig1AAIAAjLIA1AAIBgB8IAAh8IA1AAIAADLg");
	this.shape_5.setTransform(45,39.975);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAyBmIgMgkIhLAAIgMAkIg4AAIBNjLIA5AAIBNDLgAgXAaIAvAAIgYhCg");
	this.shape_6.setTransform(21.925,39.975);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("


	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#E30B48").s().p("AomC7QhGAAgygxQgygyAAhHIAAghQAAhHAygxQAygyBGAAIRNAAQBGAAAyAyQAyAxAABHIAAAhQAABHgyAyQgyAxhGAAg");
	this.shape_8.setTransform(72.075,18.725);
...
p.nominalBounds = new cjs.Rectangle(0,0,144.2,37.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(201).to({startPosition:0},0).to({_off:true},1).wait(18));

	// Symbol_5
	this.instance_1 = new lib.Symbol5("single",0);
	this.instance_1.setTransform(85.25,-247.8,1,1,0,0,0,69.7,81.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(201).to({startPosition:0},0).to({_off:true},1).wait(18));

	// Symbol_8
	this.instance_2 = new lib.Symbol8("single",0);
	this.instance_2.setTransform(611.8,-247.8,1,1,0,0,0,69.7,81.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(122).to({mode:"synched",loop:false},0).wait(79).to({startPosition:10},0).to({_off:true},1).wait(18));

	// Symbol_1
	this.instance_3 = new lib.Symbol1("single",0);
	this.instance_3.setTransform(-616.75,-247.8,1,1,0,0,0,69.7,81.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(122).to({mode:"synched",loop:false},0).wait(79).to({startPosition:10},0).to({_off:true},1).wait(18));

	// Symbol_20
	this.instance_4 = new lib.Symbol20("single",0);
	this.instance_4.setTransform(436.3,144.6,1,1,0,0,0,69.7,81.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(75).to({mode:"synched",loop:false},0).wait(126).to({startPosition:10},0).to({_off:true},1).wait(18));

	// Symbol_11
	this.instance_5 = new lib.Symbol11("single",0);
	this.instance_5.setTransform(15.55,-128);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(75).to({mode:"synched",loop:false},0).wait(126).to({startPosition:10},0).to({_off:true},1).wait(18));

	// Symbol_7
	this.instance_6 = new lib.Symbol7("single",0);
	this.instance_6.setTransform(436.3,-247.8,1,1,0,0,0,69.7,81.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(75).to({mode:"synched",loop:false},0).wait(126).to({startPosition:10},0).to({_off:true},1).wait(18));

	// Symbol_14
	this.instance_7 = new lib.Symbol14("single",0);
	this.instance_7.setTransform(-616.75,-46.4,1,1,0,0,0,69.7,81.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(201).to({startPosition:0},0).to({_off:true},1).wait(18));

	// Symbol_6
	this.instance_8 = new lib.Symbol6("single",0);
	this.instance_8.setTransform(260.8,-247.8,1,1,0,0,0,69.7,81.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(201).to({startPosition:0},0).to({_off:true},1).wait(18));

	// Symbol_18
	this.instance_9 = new lib.Symbol18("single",0);
	this.instance_9.setTransform(85.25,144.6,1,1,0,0,0,69.7,81.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(47).to({mode:"synched",loop:false},0).wait(154).to({startPosition:10},0).to({_off:true},1).wait(18));

	// Symbol_15
	this.instance_10 = new lib.Symbol15("single",0);
	this.instance_10.setTransform(-616.75,144.6,1,1,0,0,0,69.7,81.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(47).to({mode:"synched",loop:false},0).wait(154).to({startPosition:10},0).to({_off:true},1).wait(18));

	// Symbol_17
	this.instance_11 = new lib.Symbol17("single",0);
	this.instance_11.setTransform(-441.25,144.6,1,1,0,0,0,69.7,81.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(59).to({mode:"synched",loop:false},0).wait(142).to({startPosition:10},0).to({_off:true},1).wait(18));

	// Symbol_12
	this.instance_12 = new lib.Symbol12("single",0);
	this.instance_12.setTransform(-90.25,-46.4,1,1,0,0,0,69.7,81.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(59).to({mode:"synched",loop:false},0).wait(142).to({startPosition:10},0).to({_off:true},1).wait(18));

	// Symbol_19
	this.instance_13 = new lib.Symbol19("single",0);
	this.instance_13.setTransform(260.8,144.6,1,1,0,0,0,69.7,81.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(201).to({startPosition:0},0).to({_off:true},1).wait(18));

	// Symbol_16
	this.instance_14 = new lib.Symbol16("single",0);
	this.instance_14.setTransform(-265.75,144.6,1,1,0,0,0,69.7,81.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(201).to({startPosition:0},0).to({_off:true},1).wait(18));

	// Symbol_13
	this.instance_15 = new lib.Symbol13("single",0);
	this.instance_15.setTransform(-441.25,-46.4,1,1,0,0,0,69.7,81.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(151).to({mode:"synched",loop:false},0).wait(50).to({startPosition:10},0).to({_off:true},1).wait(18));

	// Symbol_9
	this.instance_16 = new lib.Symbol9("single",0);
	this.instance_16.setTransform(436.3,-46.4,1,1,0,0,0,69.7,81.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(201).to({startPosition:0},0).to({_off:true},1).wait(18));

	// Symbol_4
	this.instance_17 = new lib.Symbol4("single",0);
	this.instance_17.setTransform(-90.25,-247.8,1,1,0,0,0,69.7,81.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(10).to({mode:"synched",loop:false},0).wait(191).to({startPosition:10},0).to({_off:true},1).wait(18));

	// Symbol_3
	this.instance_18 = new lib.Symbol3("single",0);
	this.instance_18.setTransform(-265.75,-247.8,1,1,0,0,0,69.7,81.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(151).to({mode:"synched",loop:false},0).wait(50).to({startPosition:10},0).to({_off:true},1).wait(18));

	// Symbol_2
	this.instance_19 = new lib.Symbol2("single",0);
	this.instance_19.setTransform(-441.25,-247.8,1,1,0,0,0,69.7,81.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(201).to({startPosition:0},0).to({_off:true},1).wait(18));

	// Base_Board
	this.instance_20 = new lib.BackBoard("synched",0);
	this.instance_20.setTransform(-2.65,-51.55,1,1,0,0,0,685.8,278.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(201).to({startPosition:0},0).to({_off:true},1).wait(18));
...
// stage content:
(lib._20773NSGCKNOW_THE_GAME300x600A = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.shape.setTransform(-212,599.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("EhP/AAFIAAgJMCf/AAAIAAAJg");
	this.shape_1.setTransform(299.7,87.9,1,1,89.9948,0,0,-0.1,-0.3);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(278));

	// CTA2
	this.instance = new lib.CTA2("synched",0);
	this.instance.setTransform(149,476.5,0.369,0.369,0,0,0,72.1,18.7);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(259).to({_off:false},0).to({regX:72,scaleX:1,scaleY:1,x:148.9,alpha:1},12).wait(7));

	// Board Animation
	this.instance_1 = new lib.BoardAnimation("synched",0,false);
	this.instance_1.setTransform(149.35,284.65,0.1971,0.1971,0,0,0,-9.2,46.2);
	this.instance_1.alpha = 0.1914;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(76).to({_off:false},0).to({alpha:1,startPosition:9},9).wait(193));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(66).to({_off:false},0).to({alpha:1},9).wait(203));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(52).to({_off:false},0).to({alpha:1},9).wait(217));

	// LOGO
	this.instance_4 = new lib.ClipGroup();
	this.instance_4.setTransform(149,548.1,1,1,0,0,0,78,24);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(278));

	// Intro
	this.instance_5 = new lib.TitleGraphic();
	this.instance_5.setTransform(150,267.05,1,1,0,0,0,150,211);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(41).to({alpha:0},13).to({_off:true},1).wait(223));

	// Dots
	this.instance_6 = new lib.FadeyBG();
	this.instance_6.setTransform(148.95,316.35,0.323,0.323,-90,0,0,994.1,531);
	this.instance_6.alpha = 0.1992;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(278));

	// BG
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#171046").s().p("EgYDAvbMAAAhe1MAwHAAAMAAABe1g");
	this.shape_4.setTransform(149.9834,299.9853,0.974,0.9885);

	this.timeline.addTween(cjs.Tween.get(this.shape_4).wait(278));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5}]}).wait(278));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-574,-124,1598,1148);
// library properties:
lib.properties = {
